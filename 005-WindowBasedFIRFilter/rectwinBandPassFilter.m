%% 基于矩形窗的带通 FIR 滤波器
function [freq_axis, magnitude_r, phase_r, f_signal] = rectwinBandPassFilter(input1, input2, sampling_rate, h_t)
% 输入:
...
% 归一化频率
%% 设计矩形窗带通滤波器
coefficients = fir1(order, normal_freq, 'bandpass', rectwin(order + 1));
% 使用矩形窗设计 FIR 带通滤波器
%% 计算频率响应
